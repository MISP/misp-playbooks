- The [MISP playbook structure](MISP%20playbook%20structure.html) and [Jupyter notebook example](MISP%20playbook.ipynb) describe the structure of the MISP playbooks.
